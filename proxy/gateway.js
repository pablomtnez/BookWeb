...
const authService = process.env.AUTH_SERVICE || 'http://127.0.0.1:8000'; // Cambié localhost por 127.0.0.1
const bookService = process.env.BOOK_SERVICE || 'http://127.0.0.1:3001'; // Cambié localhost por 127.0.0.1
